...
create_table_queries = [create_table_immigration_staging, create_us_city_demo_staging,create_airport_codes_staging,create_world_temp_staging,
 create_country, create_entry_port, create_arrival_mode, create_region,
create_visa_type, create_gender_type, create_visa_class,create_table_immigration
]

truncate_table_queries = [truncate_table_template.format(table) for table in table_list]
